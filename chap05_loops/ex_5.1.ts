...
do {
  userGuess = Number(prompt("Guess a number between 1 - 5: "));
  if (userGuess == randomNumber) {
    isAnswerCorrect = true;
    break;
  } else if (userGuess > randomNumber) {
    console.log("Your guess is higher than computer generated random number.");
  } else {
    console.log("Your guess is lower than computer generated random number.");
  }
